...
class Ui(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # Load the image
        self.img = mpimg.imread(r'Images\area.png')
        ...
        self.horizontalSlider_firing_angle.setValue(45)
